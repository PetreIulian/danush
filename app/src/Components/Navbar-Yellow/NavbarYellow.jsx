...
const NavbarYellow = () => {
  ...
  return (
    <nav>
      <div className="nav-container-yellow">
      ...
      <div className={`menu-class-yellow ${isMenuClicked ? "visible" : "hidden"}`}>
        <ul>
          <li>
